...
// 	},
    ...
    __draw: function(label) {
        ...
        if (L.Browser.canvas && map) {
            ...
            function __draw_lat_line(self, lat_tick,label_str) {
                ...
                if (curvedLat) {
                    ...
                    for (var j=__lon_left; j<=__lon_right; j+=_lon_delta) {
                        ...
                        if (self.options.showLabel && label && _prev_p != null) {
                            if (_prev_p.x < 0 && rr.x >= 0) {
                                ...
                                //ctx.fillText("poo", 0, _y + (txtHeight/2));
                            }
                                ...
                                //ctx.fillText("poo", ww-txtWidth, _y + (txtHeight/2)-2);
                            }
                        }
                    ...
                    if (self.options.showLabel && label) {
                        ...
                        ctx.fillText(latstr, 0, _yy+offset);
                        //ctx.fillText("bobby", 0, _yy);
                        ctx.fillText(latstr, ww-txtWidth, _yy+offset);
                        //ctx.fillText("ginny", ww-txtWidth, _yy);
                    }
                }
            };
            ...
            if (latInterval > 0) {
                ...
                for (var i=0; i>=_lat_b; i-=latInterval) {
                    if (i <= _lat_t) {
                        __draw_lat_line(this, i,"Z");
                    }
                }
            }

            function __draw_lon_line(self, lon_tick,label_str) {
                ...
                if (curvedLon) {
                    ...
                    for (var j=_lat_b; j<_lat_t; j+=_lat_delta) {
                        ...
                        if (self.options.showLabel && label && _prev_p != null) {
                            if (_prev_p.y > 8 && tt.y <= 8) {
                                ...
                                //ctx.fillText("rangoon", tt.x - (txtWidth/2), txtHeight);
                            }
                            else if (_prev_p.y >= hh && tt.y < hh) {
                                ctx.fillText(lngstr, tt.x - (txtWidth/2), hh-2);
                                //ctx.fillText("rec", tt.x - (txtWidth/2), hh-2);
                            }
                        }
                    ...
                    if (self.options.showLabel && label) {
                        ctx.fillText(lngstr, tt.x - (txtWidth/2)+offset, txtHeight+1);
                        ctx.fillText(lngstr, bb.x - (txtWidth/2)+offset, hh-3);
                    }
                }
            };
